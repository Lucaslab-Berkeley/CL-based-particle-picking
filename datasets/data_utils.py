...
class PointcloudJitter2(object):
    '''
        Jitter at multiple levels of the std
    '''
    def __init__(self, clip=1.0, p=1):
        self.stds, self.clip = [0.01,0.1,0.2], clip
        self.p = p
...
class AddGaussianNoise(object):
    def __init__(self, mean=0.0, std=0.05, p=1.0):
        self.mean = mean
        self.std = std
        self.p = p
...
class AddGaussianNoise_multiple(object):
    def __init__(self, mean=0.0, stds=[0.05], p=1.0):
        self.mean = mean
        self.stds = stds
        self.p = p
...
class PointcloudNormalize_preserved(object):
    def __init__(self):
        self.radius = 180.0
